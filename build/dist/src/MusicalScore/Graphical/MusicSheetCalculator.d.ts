...
export declare abstract class MusicSheetCalculator {
     ...
     */
    calculateAsync(yielder: CooperativeYielder, onProgress?: (progress: number) => void): Promise<void>;
     ...
     */
    calculateXLayoutAsync(graphicalMusicSheet: GraphicalMusicSheet, maxInstrNameLabelLength: number, yielder: CooperativeYielder, onMeasureProcessed?: (done: number, total: number) => void): Promise<void>;
     ...
     */
    protected calculateMusicSystemsAsync(yielder: CooperativeYielder, onProgress?: (progress: number) => void): Promise<void>;
    /**
